...
void FreeBuffers(MP3DecInfo *mp3DecInfo)
{
	...
	vPortFree(mp3DecInfo->FrameHeaderPS);
	vPortFree(mp3DecInfo->SideInfoPS);
	vPortFree(mp3DecInfo->ScaleFactorInfoPS);
	vPortFree(mp3DecInfo->HuffmanInfoPS);
	vPortFree(mp3DecInfo->DequantInfoPS);
	vPortFree(mp3DecInfo->IMDCTInfoPS);
	vPortFree(mp3DecInfo->SubbandInfoPS);

	vPortFree(mp3DecInfo);
}
