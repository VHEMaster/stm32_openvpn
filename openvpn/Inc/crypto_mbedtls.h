...
#define cipher_kt_t mbedtls_cipher_info_t

/** Generic message digest key type %context. */
#define md_kt_t mbedtls_md_info_t

/** Generic cipher %context. */
#define cipher_ctx_t mbedtls_cipher_context_t

/** Generic message digest %context. */
#define md_ctx_t mbedtls_md_context_t

/** Generic HMAC %context. */
#define hmac_ctx_t mbedtls_md_context_t
